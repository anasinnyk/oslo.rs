...
impl Default for Metrics {
    fn default() -> Self {
        let reconcile_duration = HistogramVec::new(
            histogram_opts!(
                "ds_controller_reconcile_duration_seconds",
        ...
        let failures = IntCounterVec::new(
            opts!(
                "ds_controller_reconciliation_errors_total",
        ...
        .unwrap();
        let reconciliations =
            IntCounter::new("ds_controller_reconciliations_total", "reconciliations").unwrap();
        Metrics {
            reconciliations,
            failures,
            reconcile_duration,
...
impl Metrics
{
    ...
    pub fn reconcile_failure(&self, resource_name: &String, e: &Error) {
        self.failures
            .with_label_values(&[resource_name, e.metric_label().as_ref()])
            .inc()
    }
